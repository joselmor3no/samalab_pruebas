...
foreach ($estudios AS $row) {
    ...
    if ($row->id_tipo_reporte == 2 && $row->impresion > 0) {
        $estudio = array(
    ...
    if ($componente["componente"]->imprimible == 1) {
        ...
        if ($componente["componente"]->id_cat_componente == NULL) {
            ...
            if ($componente["tabla"] != NULL) {
                ...
                $cuerpo .= "
                        <td align='center' width='34%' colspan='4'>" . $componente["referencia"]->baja . " " . $formato->separador . " " . $componente["referencia"]->alta . " " . $componente["referencia"]->unidad . "</td>
                    </tr>";
            }
