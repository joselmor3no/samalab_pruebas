        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-md-2 offset-md-4 col-sm-4 offset-sm-2">
                    <a href="usuario" class="btn btn-block bg-gradient-success"><i class="fas fa-user-plus"></i>
                        Nuevo</a>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="row">
                                    ...
                                    <button class="btn btn-sm btn-danger rounded-circle m-1 delete-sucursal"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Seleccione "Eliminar" para eliminar el usuario <span id="nombre"
                    class="font-weight-bold text-primary"></span>. Esta acción no se podrá deshacer.
            </div>
            <div class="modal-footer">
                <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancelar</button>
                <form action="controller/Sucursal?opc=delete-usuario" method="POST">
