        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-md-6 col-sm-6">
                    <h1><i class="fas fa-prescription-bottle-alt nav-icon pr-2"></i><?= $page_title ?></h1>
                </div>
                <div class="col-md-2 offset-md-4 col-sm-4 offset-sm-2">
                    <a href="producto" class="btn btn-block bg-gradient-success"><i
                            class="fas fa-prescription-bottle-alt pr-2"></i> Nuevo</a>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title"> Consulta rápida de Productos</h3>
            </div>
            <div class="card-body">
                <table id="" class="table table-bordered table-hover dataTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?= $row->id ?></td>
                            <td><?= $row->nombre ?></td>
                            <td><?= $row->presenacion ?></td>
                            <td><?= $row->cantidad ?></td>
                            <td><?= $row->unidad ?></td>
                            <td><?= $row->stock_min ?></td>
                            <td><?= $row->cant_pruebas ?></td>
                            <td>
                                <div class="row">
                                    <form class="pr-2" action="producto" method="POST">
                                        <input type="hidden" name="id" value=" <?= $row->id ?>" class="d-none">
                                        <button type="submit" class="btn btn-sm btn-warning rounded-circle m-1"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Seleccione "Eliminar" para eliminar el producto <span id="nombre"
                    class="font-weight-bold text-primary"></span>. Esta acción no se podrá deshacer.
            </div>
