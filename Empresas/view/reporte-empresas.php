    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Venta global a empresas de Credito</h3>
            </div>
            <div class="card-body">

                <form class="needs-validation" action="reporte-empresas" method="post" novalidate="">
                ...
                if (count($_POST) > 0) {
                    $reportes = new Reportes();
                        ...
                        $corte = $reportes->EmpresasCredito($id_sucursal, $ini, $fin);
                        ?>

                        <input type="hidden" id="title" value="<?= "Reporte: Ventas totales empresas de credito" ?>">
