        ...
        <div class="container-fluid"  >
            <div class="row">
                <div class="col-md-6 p-0 d-none d-md-block" >
                    <div class="login login-page-main" style="background-color: white!important;">
                        <div class="text-detail">
                            <div class="imgcontainer">
                                <img src="../images-clientes/cliente_91.png" alt="Avatar" class="avatar">
                            </div>
                            <h1>Bienvenido</h1>
                            <p>Consulta tus resultados en línea</p>
                            <center><p> <strong>Copyright &copy; 2022 <a href="#">Connections</a>.<br></strong> All rights reserved.</p></center>
                    ...
                    <div class="login-page" >
                        <form class="login-form" action="controller/Acceso?opc=login" method="post" novalidate="">
                            <div class="input-control">
                                <center><h2><?= $_SESSION["cliente"]->cliente ?></h2></center>
