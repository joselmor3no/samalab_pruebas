                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    if (data[i]["componente"].id_cat_componente == null) {
                        var referencia = "<input type='hidden' name='val_componente_" + data[i]["componente"].id + "'  value='" + data[i]["componente"].componente + "'>" +
                                "<input type='hidden' name='val_leyenda_" + data[i]["componente"].id + "'  value='" + (data[i]["componente"].leyenda != null ? data[i]["componente"].leyenda : "") + "'>";
                        ...
                        var referencia = "<input type='hidden' name='val_componente_" + data[i]["componente"].id + "'  value='" + data[i]["componente"].componente + "'>" +
                                ...
                                "<input type='hidden' name='val_edad_inicio_" + data[i]["componente"].id + "'  value='" + data[i].referencia.edad_inicio + "'>" +
                                "<input type='hidden' name='val_edad_fin_" + data[i]["componente"].id + "'  value='" + data[i].referencia.edad_fin + "'>" +
                                "<input type='hidden' name='val_alta_" + data[i]["componente"].id + "'  value='" + parseFloat(data[i].referencia.alta).toFixed(puntoDecimal) + "'>" +
                                "<input type='hidden' name='val_baja_" + data[i]["componente"].id + "'  value='" + parseFloat(data[i].referencia.baja).toFixed(puntoDecimal) + "'>" +
                                "<input type='hidden' name='val_unidad_" + data[i]["componente"].id + "'  value='" + data[i].referencia.unidad + "'>" +
                                "<input type='hidden' name='val_decimales_" + data[i]["componente"].id + "'  value='" + puntoDecimal + "'>" +
                                "<input type='hidden' name='val_tabla_" + data[i]["componente"].id + "'  value='" + (data[i].tabla != null ? data[i].tabla : "") + "'>" +
                                "<input type='hidden' name='val_leyenda_" + data[i]["componente"].id + "'  value='" + (data[i]["componente"].leyenda != null ? data[i]["componente"].leyenda : "") + "'>";
                       ...
                       " + referencia + "</tr>");
                        ...
                        var referencia = "<input type='hidden' name='val_componente_" + data[i]["componente"].id + "'  value='" + data[i]["componente"].componente + "'>" +
                                "<input type='hidden' name='val_lista_" + data[i]["componente"].id + "'  value='" + predeterminado + "'>" +
                                "<input type='hidden' name='val_tabla_" + data[i]["componente"].id + "'  value='" + (data[i].tabla != null ? data[i].tabla : "") + "'>" +
                                "<input type='hidden' name='val_leyenda_" + data[i]["componente"].id + "'  value='" + (data[i]["componente"].leyenda != null ? data[i]["componente"].leyenda : "") + "'>";
                        ...
                        var referencia = "<input type='hidden' name='val_componente_" + data[i]["componente"].id + "'  value='" + data[i]["componente"].componente + "'>" +
                                "<input type='hidden' name='val_unidad_componente_" + data[i]["componente"].id + "'  value='" + (data[i]["componente"].unidad_ != null ? data[i]["componente"].unidad_ : "") + "'>" +
                                "<input type='hidden' name='val_referencia_componente_" + data[i]["componente"].id + "'  value='" + (data[i]["componente"].referencia != "" ? data[i]["componente"].referencia : "") + "'>" +
                                "<input type='hidden' name='val_tabla_" + data[i]["componente"].id + "'  value='" + (data[i].tabla != null ? data[i].tabla : "") + "'>" +
                                "<input type='hidden' name='val_leyenda_" + data[i]["componente"].id + "'  value='" + (data[i]["componente"].leyenda != null ? data[i]["componente"].leyenda : "") + "'>";
