        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-md-2 offset-md-4 col-sm-4 offset-sm-2">
                    <a href="empresa" class="btn btn-block bg-gradient-success"><i class="fa fa-building  pr-2"></i> Nueva</a>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title"> Consulta rápida de Empesas</h3>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        ...
                        foreach ($datos AS $row) {
                            ...
                            <tr>
                                ...
                                <td><?= $row->nombre ?></td>
                                <td><?= $row->telefono ?></td>
                                <td><?= $row->inactivo == "0" ? "ACTIVA" : "INACTIVA" ?></td>
                                <td> 
                                    <div class="row">
                                        <form class="pr-2" action="empresa"  method="POST">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">¿Está seguro que desea eliminar la Empresa?</h5>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body">
                Seleccione "Eliminar" para eliminar la empresa <span id="nombre" class="font-weight-bold text-primary"></span>. Esta acción no se podrá deshacer.
            </div>
            <div class="modal-footer">
                <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancelar</button>
                <form action="controller/catalogos/Empresa?opc=delete" method="POST" >
                    <input type="hidden" class="d-none" id="id_empresa" name="id_empresa" value="">
