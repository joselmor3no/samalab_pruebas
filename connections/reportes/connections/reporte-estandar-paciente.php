...
foreach ($estudios AS $row) {
    ...
    if ($row->id_tipo_reporte == 3 && $row->impresion >= 1) {
        $estandar[] = array(
...
<table width='100%' style='font-size:9pt'>
    ...
    <tr>
        ...
        <td><span style='font-weight: bold;'>MUESTRA: </span>" . ( count($estandar) == 1 ? $estandar[0]["materia"] : "" ) . "</td>
...
if ($laboratorio == 1) {
    ...
    if ($sucursal->quimico != "") {
        $quimico = ' 
            <img src="../../images-sucursales/firmas/' . ($estandar[0]["quimico"]->firma_digital != "" ? $estandar[0]["quimico"]->firma_digital : "transparente.png") . '" style="height:150px; margin-bottom:-60px; margin-top:-35px;" />                       
            <br>____________________________
            <br><b>QUIMICO RESPONSABLE</b>
            <br>' . $estandar[0]["quimico"]->nombre . '          
            <br>';
    }
            ...
            '<div style="height:' . ($formato->footer * 37.7) . 'px">
                <div style="text-align: left;">
                   ...
                   * Fuera de intervalo biológico de referencia
                   <br>
                    <span style="font-weight: bold;">Método empleado: ' . ( count($estandar) == 1 ? $estandar[0]["metodo"] : "" ) . '</span>
                   </font>
               </div>
               <table width="100%">
                   <tr>
...
<table width='100%' CELLPADDING=1 CELLSPACING=1 BORDER=0 >
    <tr>
            ...
            <font  style='$color'><b><u>" . $estudio["estudio"] . "</u></b></font>
            </td>
    </tr>";
    ...
    foreach ($estudio["componentes"] as $componente) {
        if ($componente["componente"]->imprimible == 1) {
            ...
            if ($componente["componente"]->id_cat_componente == NULL) {
                $cuerpo .= "<tr>
                        <td colspan='8'>
                           <font> " . $componente["componente"]->componente . "</font>
                        </td>
                    </tr>";
    ...
    //metodo
    if ($estudio["metodo"] != "" && count($estandar) != 1) {
        $cuerpo .= "<tr><td colspan=8 style='padding-bottom: 7px;'><span style='font-weight: bold; font-size:" . ($formato->punto - 2) . "pt'>Método empleado: " . $estudio["metodo"] . "</span></td></tr>";
    }
    $cuerpo .= "
</table>
</div>
