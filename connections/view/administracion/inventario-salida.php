                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="id_sucursal_salida" style="width: 100%; height: 100%">
                                            <?php
                                            foreach ($sucursales AS $row) {
                                                ?>
                                                <option value="<?= $row->id ?>" <?= $row->id == $id_sucursal ? "selected" : ""; ?>><?= $row->nombre ?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                                ...
                                <tbody id="tbody">
                                    ...
                                    for ($i = 1; $i <= 1; $i++) {
                                        ...
                                        <tr id='est_<?= $i ?>' class="text-center">
                                            ...
                                            <td></td>
                                            <td>   
                                                <input type="text" class="form-control form-control-border egreso" data-id="<?= $i ?>"  name="egreso[]" value="" placeholder="Egreso" required="">
                                            </td>
                                            <td></td>
