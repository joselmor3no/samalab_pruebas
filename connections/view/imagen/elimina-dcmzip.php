                                        ...
                                        <?php 
                                            foreach ($sucursales as $row => $item) {
                                                if($item->prefijo_imagen!=''){
                                                    echo '<option value="'.$item->prefijo_imagen.'">'.$item->nombre.'('.$item->codigo.')</option>';
                                                    echo '<option value="'.$item->prefijo_imagen.'_pacientes">'.$item->nombre.'('.$item->codigo.' Pacientes)</option>';
                                                }
