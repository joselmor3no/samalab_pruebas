...
for ($ite = 0; $ite < 2; $ite++) {
    ...
    $html_estudios .= '<tr>
                    ...
                    <td align="center" style="background:#366BA0; color:#fff; font-weight: bold; font-size: 9pt;">$ ' . number_format($precio, 2) . '</td> 
                    <td align="center" style="background:#366BA0; color:#fff; font-weight: bold"></td> 
