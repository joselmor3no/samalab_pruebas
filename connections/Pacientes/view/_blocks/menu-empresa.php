...
<aside class="main-sidebar sidebar-dark-success elevation-4">
    <!-- Brand Logo -->
    <a href="resultados-empresa" class="brand-link">
        ...
        <h6 class="text-center mt-2 brand-text font-weight-bold">EMPRESA</h6>
    </a>
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="resultados-empresa" class="nav-link <?=  strpos($url, 'resultados') !== false ? "active" : "" ?>">
