...
$cortes = new Cortes();
$datos_ingresos = $cortes->getIngresos();
$datos_egresos = $cortes->getEgresos();
$datos_corte = $cortes->getCorte($id_sucursal);
...
require("view/admision/corte.php");
