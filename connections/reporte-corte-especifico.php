...
if ($tipo == "detalle") {
    ...
    $cortes = new Cortes();
    $idCorte=$cortes->getIdCorteEspecifico($_REQUEST['corte'],$_REQUEST['usuario'])[0]->id;
    
    $datos_ingresos = $cortes->getIngresosUltimoCorteEspecifico($idCorte);
    $datos_egresos = $cortes->getGastosUltimoCorteEspecifico($idCorte);
    $metodo = $cortes->getMetodoIngresosUltimoCorteEspecifico($idCorte);
    $no_corte =$_REQUEST['corte'];
