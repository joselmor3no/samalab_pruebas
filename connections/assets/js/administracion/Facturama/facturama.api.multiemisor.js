//------------------------- API SANDBOX DE PRUEBA

/*var valuesFacturama = {
    token: "RWRlck1lbmRlejoxMjN1U1UyMDE5",
    url: "https://apisandbox.facturama.mx/"
};*/

//------------------------- API PRODUCCIÓN
var valuesFacturama = {
    token: "bmV0bGFic3g6bmV0bGFiZXgyMDE4",
...
(function (window) {
    function facturama() {
        ...
        function cancelarConMotivo(path, cfdiId, motive, uuidReplacement,callback,callbackError){
            $.ajax({
                url: settings.url + path + '/' + cfdiId+'?type=issued&motive='+motive+'&uuidReplacement='+uuidReplacement,
                type: 'DELETE',
                async: false,
                success: callback,
                error: callbackError
        ...
        var facturamaObject = {
            Cfdi: {
                ...
                CancelarMotivo: function(cfdiId, motive, uuidReplacement, callback, callbackError){
                    cancelarConMotivo('api-lite/cfdis', cfdiId, motive, uuidReplacement, callback, callbackError);
                },
