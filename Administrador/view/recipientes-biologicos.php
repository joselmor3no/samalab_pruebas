        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-md-6 col-sm-6">
                    <h1><i class="fas fa-vial nav-icon pr-2"></i><?= $page_title ?></h1>
                </div>
                <div class="col-md-2 offset-md-4 col-sm-4 offset-sm-2">
                    <a href="catalogo-recipiente-biologico" class="btn btn-block bg-gradient-success"><i class="fa fa-vial pr-2"></i> Nuevo</a>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title"> Consulta rápida de Recipiente Biológico</h3>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        ...
                        foreach ($datos AS $row) {
                            ...
                            <tr>
                                ...
                                <td> 
                                    <div class="row">
                                        <form class="pr-2" action="catalogo-recipiente-biologico"  method="POST">
                                        ...
                                        <button class="btn btn-sm btn-danger rounded-circle m-1 delete-estructura" data-id="<?= $row->id ?>" data-nombre="<?= $row->recipiente ?>" data-toggle="tooltip" title="Eliminar">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">¿Está seguro que desea eliminar el Recipiente Biológico?</h5>
            ...
            <div class="modal-footer">
                ...
                <form action="controller/Estructura?opc=delete-recipiente" method="POST" >
