        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-md-2 offset-md-4 col-sm-4 offset-sm-2">
                    <a href="catalogo-recipientes-biologicos" class="btn btn-block bg-gradient-success"><i class="fa fa-search pr-2"></i> Buscar</a>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title"> <?= $datos[0]->id == "" ? "Alta" : "Modificación" ?> de Recipiente</h3>
            </div>
            <div class="card-body">
                <form class="needs-validation" action="controller/Estructura?opc=registro-recipiente" method="post" novalidate="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-border text-uppercase"  name="recipiente" value="<?= $datos[0]->recipiente ?>" placeholder="Recipiente" required="">
                                <div class="invalid-feedback">
                                    Favor de capturar el campo Recipiente
                                </div>
                            </div>
                        </div>
