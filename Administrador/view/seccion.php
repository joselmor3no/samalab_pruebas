        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-md-2 offset-md-4 col-sm-4 offset-sm-2">
                    <a href="catalogo-secciones" class="btn btn-block bg-gradient-success"><i class="fa fa-search pr-2"></i> Buscar</a>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title"> <?= $datos[0]->id == "" ? "Alta" : "Modificación" ?> de Departamento</h3>
            </div>
            <div class="card-body">
                <form class="needs-validation" action="controller/Estructura?opc=registro-seccion" method="post" novalidate="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-border text-uppercase"  name="seccion" value="<?= $datos[0]->seccion ?>" placeholder="Sección" required="">
                                <div class="invalid-feedback">
                          ...
                          <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" name="agenda" type="checkbox" <?= $datos[0]->agenda == "1" ? "checked" : "" ?>>
