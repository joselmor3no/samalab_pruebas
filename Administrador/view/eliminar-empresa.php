        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-md-6 col-sm-6">
                    <h1><i class="fas fa-store-alt-slash nav-icon pr-2"></i><?= $page_title ?></h1>
                </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                if (count($_POST) > 0) {
                    ...
                    $empresas->eliminarEmpresa($id_cliente);
                }
                $datos = $empresas->getEmpresas();
                ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="eliminar-empresa" method="POST" >
                    <input type="hidden" class="d-none" id="id_empresa" name="id_cliente" value="">
