        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-md-2 offset-md-4 col-sm-4 offset-sm-2">
                    <a href="catalogo-estudio" class="btn btn-block bg-gradient-success"><i class="fa fa-clipboard-list pr-2"></i> Nuevo</a>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title"> Consulta rápida de Estudios</h3>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        ...
                        foreach ($datos AS $row) {
                            ...
                            <tr>
                                ...
                                <td> 
                                    <div class="row">
                                        <form class="pr-2" action="catalogo-estudio"  method="POST">
                                        ...
                                        <!--button class="btn btn-sm btn-danger rounded-circle m-1 delete-estudio" data-id="<?= $row->id ?>" data-nombre="<?= $row->nombre_estudio ?>" data-toggle="tooltip" title="Eliminar">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">¿Está seguro que desea eliminar el Estudio?</h5>
            ...
            <div class="modal-footer">
                ...
                <form action="controller/Estudio?opc=delete" method="POST" >
