...
$datos = $cotizaciones->getCotizaciones($fecha_inicial, $fecha_final, $id_sucursal);
...
require("view/admision/cotizacion.php" );
...
<script src="assets/js/admision/cotizacion.js"></script>
